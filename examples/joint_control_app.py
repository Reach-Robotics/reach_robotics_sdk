...
STARTUP_MESSAGE = (
    ...
    "Usage:\n"
    "  Serial (RS-232): python3 ./examples/joint_control_app.py -c serial -sp COM8\n"
    "  Serial (RS-485): python3 ./examples/joint_control_app.py -c serial -sp COM8 --half_duplex\n"
    "  Ethernet (UDP):  python3 ./examples/joint_control_app.py -c udp -ip 192.168.1.5 -up 6789\n\n"
